...
| 练习与自学出口审查 | `in-progress` | 第1–9章 50 道练习已有折叠式同编号自检要点；manifest 明确登记 9/22 章覆盖，门禁拒绝缺失、重复、跨章、未闭合和过短答案 | 第10–22章尚未补齐；自检是最低合格要点，不是开放题唯一答案或真实实验替代品 |
...
| 文档站 | `release-candidate` | 22 章正文、读者术语表、研究雷达、22 张实验卡、3 张 benchmark card、308 个章节单元测试、22 组结果精确比对、28 个 HTML/23 张可访问 Mermaid 图/50 个折叠式练习自检/1073 个内部目标检查、本地静态预览与 MkDocs 严格构建 | 尚未部署；第10–22章自检待补，截图式多尺寸、深浅色、键盘与屏幕阅读器巡检仍待人工确认 |
